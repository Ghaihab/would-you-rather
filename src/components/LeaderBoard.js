                ...
                <Card>
                    ...
                    <Card.Footer>
                        <small className="text-muted text-center">
                            <div>
                                Score: {Object.values(this.props.winner.answers).length + Object.values(this.props.winner.answers).length}
                            </div>
                        </small>
                    </Card.Footer>
                </Card>
                {this.props.users.map((user) =>  {
                    return <Card key={user.id}>
                        ...
                        <Card.Footer>
                            <small className="text-muted text-center">
                                <div>
                                    Score: {Object.values(user.answers).length + Object.values(user.answers).length}
                                </div>
                            </small>
                        </Card.Footer>
                    </Card>
